...
export default function About() {
  ...
  return (
    <PageWrapper>
      <Helmet>
        <title>
          About ZeelTech | Web Agency from Cameroon Serving the US & UK
        </title>
        <meta
          name="description"
        ...
        >
          ...
          >
            ...
            <p style={{ maxWidth: 580, margin: "0 auto", fontSize: "1.1rem" }}>
              Zeeltech started from a simple belief: great digital products
              should be accessible to businesses of every size. Founded in
              Cameroon, we've grown into a team that serves clients across
              Africa and beyond.
            </p>
          </motion.div>
        </div>
    ...
    >
      {isLoading ? (
        ...
        >
          ...
          <div
            className="skeleton"
            style={{ height: 16, width: "60%", margin: "0 auto 0.5rem" }}
          />
          <div
            className="skeleton"
            style={{ height: 12, width: "80%", margin: "0 auto" }}
          />
        </div>
      ) : (
        <div
