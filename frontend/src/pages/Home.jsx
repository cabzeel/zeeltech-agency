...
export default function Home() {
  ...
  useEffect(() => {
    ...
    api
      .get("/services?status=active&limit=3")
      .then((r) => setServices(r.data.data))
      .catch(() => {});
    api
      .get("/testimonials?status=approved&isFeatured=true")
      .then((r) => setTestimonials(r.data.data))
      .catch(() => {});
    api
      .get("/blogs?status=published&limit=3")
  ...
  return (
    <PageWrapper style={{ paddingTop: 0 }}>
      <Helmet>
        <title>
          ZeelTech Web Solutions | Professional Websites for Chiropractors &
          Small Businesses
        </title>
        <meta
          name="description"
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(240,180,41,0.08) 0%, transparent 60%)",
          }}
        />
        <div
          className="orb"
        ...
        >
          <motion.div style={{ y: heroY }}>
            ...
            >
              We Build Digital
              <br />
              <span className="gold-gradient">Products That</span>
              <br />
            ...
            >
              Zeeltech is a full-service digital agency delivering world-class
              web applications, mobile apps, and growth strategies for ambitious
              brands worldwide.
            </motion.p>
        ...
        >
          <span
            style={{
              ...
              height: 40,
              background:
                "linear-gradient(to bottom, transparent, var(--gold))",
            }}
          />
        </motion.div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="zt-grid-services">
            {(services.length ? services.slice(0, 3) : Array(3).fill(null)).map(
              (s, i) => (
                <ServiceCard
                  key={s?._id || i}
                  service={s}
      ...
      <section className="section" style={{ background: "var(--bg-1)" }}>
        <div className="container">
          <SectionHeader
            ...
            subtitle="Real projects. Real results. Real clients."
          />
          <FeaturedProjects />
        ...
        <section className="section" style={{ background: "var(--bg-1)" }}>
          <div className="container">
            <SectionHeader
              ...
              title="From the |Blog|"
              subtitle="Tips, trends and deep-dives from our team."
            />
            <div className="zt-grid-3">
              {blogs.map((b, i) => (
                <BlogCard key={b._id} b={b} index={i} />
              ))}
            </div>
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 70% 80% at 50% 50%, rgba(240,180,41,0.08) 0%, transparent 70%)",
          }}
        />
        <div
          className="container"
    ...
    >
      {isLoading ? (
        <div className="card" style={{ padding: "2rem", height: 200 }}>
          ...
          <div
            className="skeleton"
            style={{ width: "60%", height: 20, marginBottom: "0.75rem" }}
          />
        ...
        <Link
          ...
          className="card"
          style={{ padding: "2rem", display: "block", textDecoration: "none" }}
        >
          <div
            style={{
              width: 44,
...
function FeaturedProjects() {
  ...
  useEffect(() => {
    api
      .get("/projects?isFeatured=true&limit=2")
            ...
            {!p ? (
              <div className="card" style={{ height: 320 }}>
                ...
                <div style={{ padding: "1.5rem" }}>
                  <div
                    className="skeleton"
                    style={{ height: 18, width: "70%", marginBottom: 10 }}
                  />
                  <div
                    className="skeleton"
